          ...
          <Splide options={splideOptions}>
            {news.map((val, i) => (
              <SplideSlide key={i} className="mb-0.5">
                <div className="relative grid items-center pb-2 gap-4 rounded-lg shadow shadow-slate-200 ring-1 ring-slate-200  ">
                  <div className="flex items-center justify-center">
                    <img
                      src={val.img}
                      alt={`image-story-${i}`}
                      className="w-full h-auto object-cover shadow-md shadow-slate-200 roundedn-tl-lg rounded-tr-lg "
                    />
                  </div>
                  ...
                  <div className="grid items-center justify-items-start px-3">
